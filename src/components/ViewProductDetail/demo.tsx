...
export function DemoViewProductDetail() {
            ...
            <main className="col-lg-6">
              <div className="ps-lg-3">
                <small className="text-muted">
                  Ref: <b>{product.id}</b> |{" "}
                  <span>
                    {product.estoque && product.estoque > 1
                      ? `${product.estoque} itens`
                      : `${product.estoque} item`}{" "}
                    em estoque
                  </span>
                </small>
                ...
                <p className="mb-4 text-justify text-break">{product.description}</p>
